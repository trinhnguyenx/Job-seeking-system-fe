<template>
    ...
    <div class="nav-user">
        <div class="text-nav-user"> Xin chào,<b>{{ auth.getUserName() }}</b></div>
    </div>
    <div class="box-infor">
        <div class="infor">
            <div class="infor-register" @click="handleClickInfor">
                <div v-if="isArrowUp"><el-icon><ArrowDown /></el-icon></div>
                <div v-if="!isArrowUp"><el-icon><ArrowUp /></el-icon></div>
            ...
            <div class="arrowupdown" v-if="isArrowUp">
                <div class="email">
                    ...
                    <div class="input-email">
                        ...
                        <div class="icon-input"><el-icon><CircleCheckFilled /></el-icon></div>
                    </div>
                </div>
